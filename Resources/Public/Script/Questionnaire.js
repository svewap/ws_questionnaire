...
window.checkMandatory = function () {
    return jQuery("input[id^='wsqMandatory']").filter(function () {
...
window.wsqFormIsValid = function () {
    ...
    return checkAnswerErrors() === true && checkMandatory() === true;
};
...
jQuery(document).ready(function () {
    ...
    jQuery('.tx-ws-questionnaire input.prev').on('click', function () {
