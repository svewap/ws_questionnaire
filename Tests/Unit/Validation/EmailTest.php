 ...
 *
 */
class Tx_WsQuestionnaire_Validation_EmailTest extends Tx_Extbase_Tests_Unit_BaseTestCase
{

    /**
     * @var Tx_WsQuestionnaire_Validation_Email
     */
    protected $validator;
    ...
    {
        $this->validator = new Tx_WsQuestionnaire_Validation_Email();
