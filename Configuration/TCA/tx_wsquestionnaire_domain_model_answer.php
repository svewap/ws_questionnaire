...
return [
    ...
    'types' => [
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\Radiobutton::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, text, points, is_correct_answer, show_textfield,template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\Checkbox::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, text, points, is_correct_answer, show_textfield,template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        ...
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\SingleSelect::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, text, select_values, comparison_text,template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\ClozeText::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, text,template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\ClozeTextDD::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, text, cloze_add_terms,template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\ClozeTerm::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, cloze_position,template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\DDAreaImage::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, image, width, height, coords, area_highlight,template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\DDAreaSequence::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, area_highlight,template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\DDImage::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, image, width, height, area_index,template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\RankingInput::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\RankingSelect::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\RankingOrder::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\RankingTerm::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, image, width, height, area_index,template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\MatrixHeader::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, cols, max_answers, min_answers,template,add_clones,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\MatrixRow::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, title_line, show_textfield, template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
        ...
        \WapplerSystems\WsQuestionnaire\Domain\Model\AnswerType\DataPrivacy::class => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, type, title, text,template,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,starttime, endtime'],
    ],
    'palettes' => [
        '1' => ['showitem' => ''],
    ],
